                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-dark">
                                 <div class="row">
                                    <div class="col-md-10">
                                        <strong class="card-title text-light">SMS Reminders</strong>
                                    </div>
                                    <div class="col-md-2">
                                        <button @click="openModal" type="button" class="btn btn-primary">Add SMS</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="mediumModalLabel">Send Message</h5>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="company" class="form-control-label">Target:</label>
                            <select v-model="form.target" name="select" id="select" class="form-control">
                                <option value="0">Please select target</option>
                                <option value="1">Students</option>
                                <option value="2">Admmins</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label  class="form-control-label">Message:</label>
                            <textarea v-model="form.message" name="textarea-input" id="textarea-input" rows="9" placeholder="Content..." class="form-control" spellcheck="false"></textarea>
                        </div>
                        <div class="form-group">
...
export default {
    data() {
        return {
            fields: ['#','name', 'message', 'created_at','actions'],
            items: [
