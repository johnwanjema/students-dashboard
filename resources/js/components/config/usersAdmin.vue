                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-dark">
                                 <div class="row">
                                    <div class="col-md-10">
                                        <strong class="card-title text-light">Admin</strong>
                                    </div>
                                    <div class="col-md-2">
                                        <button @click="openModal" type="button" class="btn btn-primary">Add Admin</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 v-if="!editMode" class="modal-title" id="mediumModalLabel">Add Admin</h5>
                        <h5 v-else class="modal-title" id="mediumModalLabel">Update Admin</h5>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="company" class="form-control-label">First Name:</label>
                            <input v-model="form.first_name" type="text"  placeholder="Enter first name" class="form-control" />
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input v-model="form.phone_no" type="text" placeholder="Enter phone number" class="form-control" />
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button v-if="!editMode" type="button" class="btn btn-primary">Add Admin</button>
                        <button v-else type="button" class="btn btn-primary">Update Admin</button>
...
export default {
    data() {
        return {
            fields: ['#','name', 'phone_no','role', 'created_at','actions'],
            items: [
                {name :'John Doe',phone_no:'07212739', role:'admin', created_at:'10/12/2020'}
            ],
            perPage: 5,
            currentPage: 1,
            filter: null,
